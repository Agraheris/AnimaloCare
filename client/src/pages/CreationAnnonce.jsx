  ...
  return (
    ...
    <Form>
      <Form.Group className="mb-3" controlId="Title">
        ...
        <Form.Control type="text" placeholder="Garde de chat" value={formData.title} onChange={handleChangeTitle} />
      </Form.Group>

      <Form.Select className="mb-3" value={formData.petType} onChange={handleChangePetType}>
      ...
      <Form.Group className="mb-3" controlId="Content">
        ...
        <Form.Control type="text" as="textarea" rows={5}  placeholder="Contenu de l'annonce" value={formData.content} onChange={handleChangeContent} />
      </Form.Group>
  
      <Form.Group className="mb-3" controlId="Location">
        <Form.Label>Ville</Form.Label>
        <Form.Control type="text" placeholder="Paris" value={formData.location} onChange={handleChangeLocation} />
      </Form.Group>

      <Form.Group className="mb-3" controlId="Price">
        <Form.Label>Tarif horaire</Form.Label>
        <Form.Control type="number" placeholder="10" value={formData.price} onChange={handleChangePrice} />
      </Form.Group>

      <Form.Group className="mb-3" controlId="StartDate">
        <Form.Label>Début de la garde</Form.Label>
        <Form.Control type="date"  value={formData.startDate} onChange={handleChangeStartDate} />
      </Form.Group>

      <Form.Group className="mb-3" controlId="EndDate">
        <Form.Label>Fin de la garde</Form.Label>
        <Form.Control type="date"  value={formData.endDate} onChange={handleChangeEndDate} />
      </Form.Group>
